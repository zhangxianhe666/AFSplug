  ...
  const links = [
    {
      ...
      icon: Github,
      url: 'https://github.com/zhangxianhe666/AFSplug',
    },
    {
      label: t('about.documentation'),
      icon: FileText,
      url: 'https://github.com/zhangxianhe666/AFSplug/blob/main/docs/README.md',
    },
    {
      label: t('about.reportIssue'),
      icon: Bug,
      url: 'https://github.com/zhangxianhe666/AFSplug/issues',
    },
  ]
